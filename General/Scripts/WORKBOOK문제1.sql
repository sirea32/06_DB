...
SELECT STUDENT_NAME
FROM TB_STUDENT
WHERE SUBSTR(STUDENT_NO, 1) IN ('A513079', 'A513090', 'A513091', 'A513110', 'A513119')
...
WHERE STUDENT_ADDRESS LIKE '%전주%'
	AND SUBSTR(STUDENT_NO, 2, 1) IN ('2')
	AND ABSENCE_YN = 'N';
...
-- 나이는 '만'으로 계산한다.)
SELECT PROFESSOR_NAME 교수이름, PROFESSOR_SSN, CEIL( (PROFESSOR_SSN - TO_DATE('2024-08-16', 'YYYY-MM-DD')) / 12 ) 나이
FROM TB_PROFESSOR;
