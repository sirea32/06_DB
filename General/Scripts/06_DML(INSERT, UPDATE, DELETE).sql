...
VALUES(900, '장채현', '001123-2345678', 'jang_ch@kh.or.kr', 
			'01012341234','D1', 'J7', 'S3', 4300000, 0.2, 200, SYSDATE, 
			 NULL, 'N'); -- 컬럼순서 지켜서 작성

-- 전체 행 개수 증가 확인
SELECT COUNT(*)
FROM EMPLOYEE2; -- 24행이지만 위에 INSERT 작동하면 1씩 증가
...
INSERT INTO EMPLOYEE2(
											EMP_NAME, EMP_ID, EMP_NO, EMAIL, PHONE, 
											DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY
											)

VALUES('장채현', 900, '001123-2345678', 'jang_ch@kh.or.kr', 
...
-- 서브쿼리를 이용해서 여러 행 INSERT하기
--> 서브쿼리 결과(RESULT SET)을 통째로 삽입하기
INSERT INTO EMP_01
(SELECT
		EMP_ID,
		EMP_NAME,
...
-- DEPT_TITLE을 '전력기획팀'으로 수정
UPDATE DEPARTMENT2
SET DEPT_TITLE = '전력기획팀'
WHERE DEPT_ID = 'D9';
...
-- EMPLOYEE2테이블에서 아시아지역에 근무하는 직원의 보너스를 0.3으로 변경
