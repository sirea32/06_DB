...
FROM DUAL; -- DUAL -> DUMMY TABLE(가상, 가짜 테이블)
...
SELECT 'AABAACAABBAA', INSTR('AABAACAABBAA', 'B', 5) -- 5, 1 -> 1은 첫번째 B위치 생략되어있음
FROM DUAL; -- 9
...
SELECT 
	MONTHS_BETWEEN(TO_DATE('2024-09-16', 'YYYY-MM-DD'), CURRENT_DATE)
FROM DUAL; -- 1(달)
